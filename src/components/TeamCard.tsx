...
export function TeamCard({src, name, designation}: TeamCardProps) {
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#B11F1F" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#B11F34" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#B11F43" />
      </g>
      <defs>
        <filter
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.214779" stopColor="#B11F1F" />
          <stop offset="0.781583" stopColor="#B11F1F" stopOpacity="0" />
        </linearGradient>
        <linearGradient
        ...
        >
          <stop offset="0.214779" stopColor="#B11F1F" />
          <stop offset="0.781583" stopColor="#B11a1F" stopOpacity="0" />
        </linearGradient>
        <linearGradient
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#B11F1F" />
          <stop offset="1" stopColor="#B11F1F" stopOpacity="0" />
        </linearGradient>
        <linearGradient
